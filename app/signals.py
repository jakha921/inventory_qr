...
from app.models import RoomInventory, EmployeeInventory
...
# Signal executed after saving a RoomInventory object and EmployeeInventory object
...
# @receiver(pre_delete, sender=EmployeeInventory)
